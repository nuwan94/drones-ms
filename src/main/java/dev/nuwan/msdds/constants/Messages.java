...
public final class Messages {
  ...
  public static final String DRONE_WEIGHT_LIMIT_EXCEED = "Can't load this medication to drone'";
  public static final String DRONE_LOADED_SUCCESSFULLY = "Medication loaded to drone successfully";
  ...
  public static final String MEDICATION_DELETE_FAILURE = "Medication delete failed";
